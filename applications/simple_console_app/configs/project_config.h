...
#define ADP_DISPATCHER_MODULE_DEBUG                   0
...
#define ADP_CONSOLE_MODULE_DEBUG                      0
...
#define ADP_TCPIP_MODULE_DEBUG                        0
#define ADP_IPNET_HOSTNAME                           "AdpHostName"
#define ADP_IPNET_SOCKETS_MAX_NUMBER                 25

// APP MQTT settings
#define ADP_MQTT_MODULE_DEBUG                         0
#define ADP_MQTT_AGENT_MODULE_DEBUG                   1
